...
from api.selection import router as selection_router
from api.bearing_units import router as bearing_units_router
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Для разработки. В проде заменить на конкретные домены
...
async def startup_event():
    ...
    print("🔍 Альтернативная документация: /redoc")
